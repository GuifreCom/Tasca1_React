...
function Grid2() {
    ...
    return(
        <Grid container spacing={2} style={{paddingTop:"70px",justifyContent:"center"}}>
            {lol.map((champion, index) => (
                <Grid key={index} size={{xs:12, md:6,  lg:4, xl:3}}>
                    <Component
                        imatge={champion.imatge}
                        titol={champion.titol}
                        textp={champion.textp}
                        textb1={champion.textb1}
                        enllaç1={champion.enllaç1}
                        textb2={champion.textb2}
                        enllaç2={champion.enllaç2}
                    />
                </Grid>
            ))}
        </Grid>
